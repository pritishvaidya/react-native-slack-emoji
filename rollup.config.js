...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-slack-emoji.js',
    format: 'umd',
    globals,
    name: 'slack-emoji',
    sourcemap: true,
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-slack-emoji.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-slack-emoji.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-slack-emoji.esm.js',
    }),
  ],
};
